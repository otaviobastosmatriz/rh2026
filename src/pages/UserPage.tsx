...
import { FileText, Link, User, Mail } from 'lucide-react'; // Adicionado User e Mail para os campos de info
...
const UserPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-start relative">
      <Header />
      <Card className="w-full max-w-3xl mx-auto mt-20 p-8 bg-white rounded-lg shadow-lg z-0">
        <CardContent className="p-0">
          <h2 className="text-heliopurple text-center text-2xl font-bold mb-2">Seja bem-vindo (a)</h2>
          ...
          <div className="space-y-4 mb-8">
            <div className="p-4 border border-gray-200 rounded-md bg-gray-50">
              <p className="text-sm text-gray-500 flex items-center mb-1">
                <User className="h-4 w-4 mr-2 text-heliopurple" /> NOME
              </p>
              <p className="text-lg font-semibold text-gray-800">{user.name}</p>
            </div>
            <div className="p-4 border border-gray-200 rounded-md bg-gray-50">
              <p className="text-sm text-gray-500 flex items-center mb-1">
                <Mail className="h-4 w-4 mr-2 text-heliopurple" /> E-MAIL
              </p>
